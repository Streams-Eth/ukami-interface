...
import { BUSD, UKAMI, USDC } from '@pancakeswap/tokens'
...
export const useCakeBusdPrice = (
  ...
  const ukami: Token = isTestnet ? UKAMI[ChainId.BSC_TESTNET] : UKAMI[ChainId.BSC]
  return usePriceByPairs(BUSD[ukami.chainId], ukami)
}
