...
export const DEFAULT_META: PageMeta = {
  title: 'UkamiSwap',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by UkamiSwap), NFTs, and more, on a platform you can trust.',
  image: 'https://app.ukami.io/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    ...
    defaultTitleSuffix: t('UkamiSwap'),
  }
}
